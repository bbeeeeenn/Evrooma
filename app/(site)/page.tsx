...
export default function Home() {
    ...
    return (
        <>
            <section className="font-inter relative flex h-svh min-h-142.5 snap-start flex-col items-center justify-center overflow-hidden text-white">
                <Image
                    src={"/csu.jpg"}
                    height={2000}
                    width={2000}
                ...
                <button
                    ...
                    className="bg-yellow-primary font-poppins bottom-0 mt-20 flex cursor-pointer items-center justify-center gap-2 rounded-md px-14 py-2.5 text-lg font-semibold tracking-wider text-black/75 sm:px-20"
                >
